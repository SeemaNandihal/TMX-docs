...
You can create a bill for an assignee or a project by choosing the "new bill" option. The billing module is available in list and detail views. 
...
The payments for the assignees services or projects must be made after the PM has authorized the completed file. When the accounting department completes the payment, the PM must update the pending payment status to paid payment status in the detail view, which also updates the outstanding amount to zero. 
